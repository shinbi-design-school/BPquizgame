...
<!DOCTYPE html><html>
	...
	<meta charset="UTF-8">
	<meta http-equiv="refresh" content="11.7; url=http://localhost:8080/BPquizgame/timeover.jsp" />
   ...
   <form action="http://localhost:8080/BPquizgame/QuizQuestion1" method="GET">
	<input id="Question1" type="hidden" name="Q1" value="Q1"> 
