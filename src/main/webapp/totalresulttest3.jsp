...
ホーム画面へ戻る場合は、以下のボタンをクリックしてください。<br/><br/>
	<button type="button" onclick=location.href="http://localhost:8080/BPquizgame/starttest.jsp">戻る</button>
<br/>
<hr>
<a href="http://localhost:8080/BPquizgame/QuizQ1.jsp">戻る</a><br>
</div></body>
</html>